    ...
    return (<div className="SBContent">
        ...
        <div className="aira_info">
                ...
                <h1 style={{fontWeight: "normal"}}>
                    ...
                    <br /><font style={{fontSize: "26px", opacity: "0.25"}}>Engine v5.1.69</font>
                    <br /><font style={{fontSize: "26px", opacity: "0.25"}}>Last update 32 minues ago. <u>See changelog</u>.</font>
                    <br /><font style={{fontSize: "26px", opacity: "0.5"}}>(c) 2023 Aira / Made with 💚 by Swiftly</font>
                </h1>
        </div>
    </div>)
}