...
export const airatheme = createTheme({
    ...
    styles: [
      ...
      { tag: t.heading1, color: cssvar("heading1"), fontSize: "calc(var(--editor-font-size) + 10px)!important" },
      { tag: t.heading2, color: cssvar("heading2"), fontSize: "calc(var(--editor-font-size) + 7px)!important" },
      { tag: t.heading3, color: cssvar("heading3"), fontSize: "calc(var(--editor-font-size) + 4px)!important" },
      { tag: t.heading4, color: cssvar("heading4"), fontSize: "calc(var(--editor-font-size) + 1px)!important" },
      ...
      { tag: t.strikethrough,    color: cssvar("md-strikethrough"), textDecoration: "line-through" },
